...
const Book = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-zinc-50 overflow-hidden p-2 pb-28">
      ...
      {/* ── Sticky Confirm Bar ── */}
      <div className="fixed bottom-0 left-0 w-full z-[998] bg-white/90 backdrop-blur-xl border-t-2 border-zinc-100">
        <div className="max-w-lg mx-auto p-3 flex items-center gap-4">
          {/* Price summary */}
          {params.price && (
